...
public class Step2 {
    public static void main(String[] args) {
         ...
         *               = [ 51, 67 ] 안됨!
         *           - 새로운 배열을 만들고 기존배열을 복사해서 새로운 값 대입. 해야함.
         *   3. 선언
         *       - 변수 선언 : (타입) 변수명;
         *       - 배열 선언 : (타입)[] 변수명;
         * 주의점! 타입[] 변수명 이라는것은 변수명에 타입이 들어간다는 것이지 타입 그 자체가 배열이 아님
         * 이거 헷갈려서 자바 클래스 생성시에 자꾸 클래스 그 자체를 배열로 생각함. 클래스가 들어가는 배열이 생긴거임.
         * ★★★★★★★★★★★★★★★(클래스이름)[] 변수명 = new 클래스이름[갯수]; ★★★★★★★★★★★★★
         *
         *   4. 값 목록으로 배열 선언
        ...
        String[] 내용 = new String[3]; // 스트링이 3개들어가는 내용이라는 변수이름(스택)의 배열이 생긴다는 것임.
        String[] 작성자 = new String[3]; // 스트링이 3개들어가는 작성자라는 변수이름(스택)의 배열이 생긴다는 것임.
        int[] 비밀번호 = new int[3];
        System.out.println();
