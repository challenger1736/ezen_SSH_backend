...
//            //System.out.println(Double.isNaN(Integer.parseInt(피연산자1)*1.0)); 숫자입력시 > false
//            while(true) { // 반복문 시작
//            System.out.println(피3);
//            System.out.print("연산자를 입력하세요.( +, - , *, / ) : ");
//연산자 = scanner.nextLine();
//            System.out.print("계산할 수를 입력하세요. : ");
//피연산자2 = scanner.nextLine();
////System.out.println(Double.isNaN(Integer.parseInt(피연산자2)*1.0)); 숫자입력시 > false
//            if (!Double.isNaN(Integer.parseInt(피연산자1)) && !Double.isNaN(Integer.parseInt(피연산자2))){ //if 유효성 검사 시작
//
//int 피1 = Integer.parseInt(피연산자1);
//int 피2 = Integer.parseInt(피연산자2);
//
//
//                if (연산자.equals("+")) {
//피3 += 피1 + 피2;
//                    System.out.println(피3);
//                    System.out.printf("%f + %f = %f", 피1, 피2, 피3);
//                } else if (연산자.equals("-")) {
//피3 += 피1 - 피2;
//                    System.out.printf("%f - %f = %f", 피1, 피2, 피3);
//                } else if (연산자.equals("*")) {
